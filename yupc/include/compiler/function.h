...
namespace yupc::compiler::function {
    ...
    void func_call_codegen(std::string func_name, size_t expr_length, 
                        std::vector<llvm::Value*> args, std::string text);

    void func_sig_codegen(bool is_external, std::string name, 
                        llvm::Type *return_type, std::vector<llvm::Type*> param_types, 
